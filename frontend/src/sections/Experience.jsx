          ...
          >
            ...
            <div className="flex-1 md:max-w-[calc(50%-2rem)] min-w-0">
              <div className="relative bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow">
                <div className="absolute -left-6 md:left-1/2 top-6 w-6 h-6 md:w-8 md:h-8 rounded-full bg-primary-500 flex items-center justify-center -translate-x-1/2">
                ...
                <div className="pl-0">
                  ...
                  <p className="text-primary-500 font-semibold mb-1 sm:mb-2 text-sm sm:text-base">{exp.company}</p>
